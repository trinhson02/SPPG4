            ...
            <div class="container">
                ...
                <div class="row mb-5 justify-content-center">
                    <div class="col-lg-5 mx-auto order-1" data-aos="fade-up" data-aos-delay="200">
                        <form action="VerifyCode" method="post" class="form-box">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <h1 class="mb-4 heading text-center" data-aos="fade-up" data-aos-delay="100">Verify code from your email</h1>
                                </div>
                                <input type="hidden" class="form-control" name="email" value="${email}">
                                <input type="hidden" class="form-control" name="action" value="${action}">
                                <div class="col-12 mb-3">
                                    <input type="number" class="form-control" required ${success != null ? 'readonly':''} placeholder="Code" name="code" value="${code}">
                                </div>
                                <div class="col-12 mb-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="submit" style="padding: 12px 24px; background-color: #4285f4; color: #fff; border: none; border-radius: 4px; cursor: pointer; width: 100%;" value="Verify">
