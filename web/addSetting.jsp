                                        ...
                                        <form action="settings" method="post">
                                            ...
                                            <div class="form-group ${error != null ? 'has-error':''}">
                                                <c:if test="${error != null}">
                                                    <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> ${error}</label>
                                                </c:if><br>
                                                
                                                <label>Name</label>
                                                <input type="text" name="name" value="${setting.getName()}" class="form-control" placeholder="Enter Setting Name ...">
                                            </div>
                                            <div class="form-group">
                                                <label>Type</label>
                                            ...
                                            <div class="form-group text-center">
                                                <button type="submit" class="btn btn-success"><i class="fa fa-pencil"></i>Add Setting</button>
