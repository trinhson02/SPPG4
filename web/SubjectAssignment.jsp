                            ...
                            <div class="container card shadow d-flex justify-content-center mt-5">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show" id="pills-home" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <div class="order">
                                            <div>
                                                <form action="SubjectAssignment">
                                                    <input type="hidden" name="subID" value="${requestScope.subID}">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-3">
                                                            <label for="inputEmail4">Search By Name</label>
                                                            <input type="email" class="form-control" name="search" id="inputEmail4" value="${requestScope.search}" placeholder="Search By Title ....">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                            <label for="inputEmail5">Start Date</label>
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <label for="inputEmail6">End Date</label>
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addAssignment"><span class="status process">Add New Assignment</span></button>
                                                </form>
                                            </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    Do you want to delete assignment with title ${u.title}
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/SubjectAssignment?id=${u.id}&action=delete&subID=${requestScope.subID}'" class="btn btn-primary">Save changes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal fade" id="assUpdate${u.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="${pageContext.request.contextPath}/SubjectAssignment" method="post">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="${pageContext.request.contextPath}/SubjectAssignment" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="recipient-code" class="col-form-label">Title</label>
                                                            <input type="text" class="form-control" id="recipient-code" name="title" required="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="col-form-label">Start Date</label>
