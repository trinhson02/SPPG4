    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-lg-5 mx-auto order-1" data-aos="fade-up" data-aos-delay="200">
                <form action="forgot" method="post" class="form-box">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <h1 class="mb-4 heading text-center" data-aos="fade-up" data-aos-delay="100">Fill your email</h1>
                        </div>
                        <div class="col-12 mb-3">
                            <input type="text" class="form-control" required ${error != null ? 'readonly':''} placeholder="Email" name="email" value="${email}">
                        </div>
                        <div class="col-12 mb-3">
                            <span style="color: red">${error}</span>
                        </div>
                        <div class="col-12">
                            <input type="submit" value="Verify" style="padding: 12px 24px; background-color: #4285f4; color: #fff; border: none; border-radius: 4px; cursor: pointer; width: 100%;">
                        </div>
                    </div>
                </form>
            </div>
