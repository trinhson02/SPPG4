            ...
            <div class="container">
                ...
                <div class="row mb-5 justify-content-center">
                    <div class="col-lg-5 mx-auto order-1" data-aos="fade-up" data-aos-delay="200">
                        <form action="forgotPhone" method="post" class="form-box">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <h1 class="mb-4 heading text-center" data-aos="fade-up" data-aos-delay="100">Forgot Password Phone</h1>
                                </div>
                                ...
                                <script>
                                        ...
                                        const firebaseConfig = {
                                            apiKey: "AIzaSyCiNyPdqZqQFSWc8_C5aFIJSLZe7l16Dbs",
                                            authDomain: "f8-group.firebaseapp.com",
                                            projectId: "f8-group",
                                            storageBucket: "f8-group.appspot.com",
                                            messagingSenderId: "418812239824",
                                            appId: "1:418812239824:web:d1e29b4fae29b3abd1e3d5",
                                            measurementId: "G-740LBFPCXF"
                                        };
                                        ...
                                        function codeverify() {
                                            ...
                                            coderesult.confirm(code).then(function () {
                                                ...
                                                window.location.href = "reset?phone=" + phone;
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="submit" style="padding: 12px 24px; background-color: #4285f4; color: #fff; border: none; border-radius: 4px; cursor: pointer; width: 100%;" ${success != null ? 'disabled':''} value="Login">
