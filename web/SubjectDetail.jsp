                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show" id="pills-home" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <div class="order">                
                                            <div >
                                                <div >
                                                    <form action="subjectDetail">
                                                        <input type="hidden" name="subID" value="${requestScope.subID}">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4">
                                                                <label for="inputEmail4">Search Class</label>
                                                                <input type="text" name="search" class="form-control" id="inputEmail4" value="${requestScope.search}" placeholder="Search By Name/Code ....">
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addClass"><span class="status process">Add New Class</span></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="button" onclick="window.window.location.href = '${pageContext.request.contextPath}/subjectDetail?id=${u.id}&action=delete&subID=${requestScope.subID}'" class="btn btn-primary">Save changes</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="box-footer clearfix" style="margin-left: 44%">
                                                <ul class="pagination pagination-sm no-margin pull-left text-center">
                                                    <c:if test="${requestScope.pagenum > 1}">
                                                        <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectDetail?pagenum=${requestScope.pagenum - 1}&subID=${requestScope.subID}">Previous</a></li>
                                                        </c:if>
                                                        ...
                                                        <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectDetail?pagenum=${i}&subID=${requestScope.subID}">${i}</a></li>
                                                        </c:forEach>
                                                        <c:if test="${requestScope.pagenum < requestScope.totalPage}">
                                                        <li class="page-item"><a style="font-size: larger;" class="page-link" href="${pageContext.request.contextPath}/subjectDetail?pagenum=${requestScope.pagenum + 1}&subID=${requestScope.subID}">Next</a></li>
                                                        </c:if>
                                                </ul>
                                            </div>
