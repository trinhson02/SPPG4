            ...
            <div class="container">
                ...
                <div class="row mb-5 justify-content-center">
                    <div class="col-lg-5 mx-auto order-1" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form action="reset" method="post" class="form-box">
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <input type="password" class="form-control" required placeholder="Password" name="pass_one">
                                </div>
                                <div class="col-12 mb-3">
                                    <input type="password" class="form-control" required placeholder="Re enter passowrd" name="pass_two">
                                </div>
